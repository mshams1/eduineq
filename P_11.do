...
regress ln_nkol1_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if  grh    == 1 & no_dip == 10
estadd beta
estimates store model1

regress ln_nkol1_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if  grh    == 2 & no_dip == 11
estadd beta
estimates store model2

regress ln_nkol1_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if  grh    == 3 & no_dip == 12
estadd beta
