...
tabout jnc sahmn lang area [aw=pop] if grh == 1 ///
using table01.xls, replace  ///
cells(mean nkol1_mean sd nkol1_mean uwsum pop)  ///
format(0 2 0c) clab(mean sd pop) sum oneway

tabout jnc sahmn lang area [aw=pop] if grh == 2 ///
using table02.xls, replace  ///
cells(mean nkol1_mean sd nkol1_mean uwsum pop)  ///
format(0 2 0c) clab(mean sd pop) sum oneway

tabout jnc sahmn lang area [aw=pop] if grh == 3 ///
