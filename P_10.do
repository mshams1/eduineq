...
regress ln_new_MDLT_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if  grh    == 1 & no_dip == 10
estadd beta
estimates store model1

regress ln_new_MDLT_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if  grh    == 2 & no_dip == 11
estadd beta
estimates store model2

regress ln_new_MDLT_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if  grh    == 3 & no_dip == 12
estadd beta
estimates store model3
}

estout model1 model2 model3, stats(N r2 ) cells(b(star fmt(2)) t(par fmt(2))) ///
starlevels(* 0.10 ** 0.05 *** 0.01) drop(0.jnc 0.D_sahmn_2 0.D_sahmn_3 0.D_sahmn_4 0.lang 0.D_area_2 0.D_area_3 0.D_area_4 0.D_area_5)  
