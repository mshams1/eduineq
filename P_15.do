...
regress ln_nkol1_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if nkol1_mean > 0 & grh    == 1 & no_dip  == 10
noisily vif

regress ln_nkol1_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if nkol1_mean > 0 & grh    == 2 & no_dip  == 11
noisily vif

regress ln_nkol1_mean i.jnc i.D_sahmn_* i.lang i.D_area_*  [fw=pop] if nkol1_mean > 0 & grh    == 3 & no_dip  == 12
noisily vif
}
